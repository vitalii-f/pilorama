...
const mobileMenu = (
    <StyledMobileNav className='mobile-menu'>
        ...
        {userData.role && userData.role.includes('admin') && <StyledMobileLi><AdminPanelSettingsIcon /><StlyedNavLink to='/admin'>Создать новость</StlyedNavLink></StyledMobileLi>}
    ...
    <>  
        ...
        <StyledDesktopNav>
            ...
            <StyledDesktopUl>
                ...
                {userData.role && userData.role.includes('admin') && <li><StlyedNavLink to='/admin'>Создать новость</StlyedNavLink></li>}
